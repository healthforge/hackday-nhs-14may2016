import template from './d3Hackday.html';
import './d3Hackday.styl';
import d3 from 'd3';

let d3HackdayComponent = function($compile) {
	return {
		scope: {
			val: '=',
			grouped: '=',
...
d3HackdayComponent.$inject = ['$compile'];

export default d3HackdayComponent;
